...
def comparators():
    return { 
        'autoencoder_for_dt' : autoencoder_for_dt
    }

# This works only for DT occupancy histograms !!!!!
def autoencoder_for_dt(histpair, **kwargs):
    ...
    #print("data_hist_orig: ", data_hist_raw)
    #print( conditions )
    #exit()
